...
<style>
    ...
    .custom-modal .modal-dialog {
        ...
        max-width: 800px;
        /* Specify the desired maximum width */
        width: 90%;
            ...
            <ul>
                ...
                <li class="dropdown">
                    ...
                    <ul id="homeSubmenu1">
                        ...
                        <li  class="active" >
                            <a href="{{ route('admin_acc')}}">Admin Account</a>
                        </li>
                    </ul>
                </li>
                <li class="dropdown">
                ...
                <li class="dropdown">
                    ...
                    <ul class="collapse list-unstyled menu" id="pageSubmenu3"> 
                        <li>
                            <a href="{{ route('comp_pending')}}">Pending</a>
                        </li>
                        <li>
                            <a href="#">Ongoing</a>
                        </li>
                        ...
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-6 p-0 flex justify-content-lg-start justify-content-center">
                                    <h2 class="ml-lg-2">List of Complaints</h2>
                                </div>
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                <tr>
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="viewImageModalLabel">Complaint Information</h5>
                                                    </div>
                                                    <div class="modal-body">
                                                        <div class="info-row">
                                                            <p><strong>Full Name: </strong>Cerafica Jr. Alejandro R</p>
                                                        </div>
                                                        <div class="info-row">
                                                            <p><strong>Contact:</strong> 09217488822</p>
                                                        </div>
                                                        <div class="info-row">
                                                        </div>
                                                        <p><strong>Address:</strong> 11 a Delos Santos Street East Rembo Makati City</p>
                                                        <p> <strong>Reason for Complaint:</strong> <br> It is a valid supporting document that can be used for several situations. For example, getting a job, applying for a business permit, opening a bank account, and applying for another ID among many others! It has a validity of 6 months. </p>
                                                    </div>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <button type="button" class="button1" data-toggle="modal" data-target="#acceptModal">ADD</button>
