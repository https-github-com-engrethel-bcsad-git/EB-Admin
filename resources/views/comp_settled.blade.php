            ...
            <ul>
                ...
                <li class="dropdown">
                    ...
                    <ul id="pageSubmenu4">
                        ...
                        <li>
                            <a href="{{ route('comp_ongoing')}}">Ongoing</a>
                        </li>
                        <li class="active">
                            <a href="{{ route('comp_settled')}}">Settled</a>
                        </li>
                    </ul>
                </li>
                <li>
                        ...
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-6 p-0 flex justify-content-lg-start justify-content-center">
                                    <h2 class="ml-lg-2">List of Settled Complaints</h2>
                                </div>
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>6-5-2023</td>
                                    <td>
                                        <span class="ongoing-dot"></span> Settled
                                    <td>
                                        <div class="btn-group">
                                            <!-- <button type="button" class="button1" data-toggle="modal" data-target="#acceptModal">Settle</button> -->
